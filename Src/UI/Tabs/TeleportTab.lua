...
function TeleportTab.Create(Window, Features, CONFIG, WindUI)
    ...
    -- Explicit Important Landmarks
    LandmarkSection:Button({
        Title = "Fishing Hut",
        Desc = "Teleport to Fishing Hut",
        Callback = function()
            if Features.Teleport then
                local success, err = Features.Teleport.TeleportToLandmark("Fishing Hut")
                if success then
                    WindUI:Notify({
                        Title = "Teleporting",
                        Content = "Going to Fishing Hut...",
                        Icon = "map",
                        Duration = 2,
                    })
                else
    ...
    LandmarkSection:Button({
        Title = "Volcano",
        Desc = "Teleport to Volcano Altar",
        Callback = function()
            if Features.Teleport then
                local success, err = Features.Teleport.TeleportToLandmark("Volcano")
                if success then
                    WindUI:Notify({
                        Title = "Teleporting",
                        Content = "Going to Volcano...",
                        Icon = "map",
                        Duration = 2,
                    })
                else
    ...
    LandmarkSection:Button({
        Title = "Kings Palace",
        Desc = "Teleport to Kings Palace",
        Callback = function()
            if Features.Teleport then
                local success, err = Features.Teleport.TeleportToLandmark("Kings Palace")
                if success then
                    WindUI:Notify({
                        Title = "Teleporting",
                        Content = "Going to Kings Palace...",
                        Icon = "map",
                        Duration = 2,
                    })
                else
